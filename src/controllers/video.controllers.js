...
const getAllVideos = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, videos[0].data, "Videos fetched successfully")
    )
    // userId - ?
})
...
const publishAVideo = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, video, "Video create successfully ")
    )
})
...
const togglePublishStatus = asyncHandler(async (req, res) => {
    ...
    .status(200)
    .json(
        new ApiResponse(200, toggleVideo, "Toggle completed")
    )
})
...
const updateViews = asyncHandler(async(req, res) => {
    ...
    const updatedVideo = await Video.findByIdAndUpdate(
      ...
      .status(200)
      .json(
        new ApiResponse(200, updatedVideo, "Views Update successfully")
      )
})
